 ...
 */
public class AdminViewUserQueries extends javax.swing.JFrame {

    /**
     * Creates new form AdminViewUserQueries
     */
    static String username;
    public AdminViewUserQueries(String username) {
 ...
 private void display() {
        ...
        String sql = "{call DisplayContactUs()}"; // Call the stored procedure
        ...
        try (Connection conn = DriverManager.getConnection(connectionString, "admin", "123456");
            ...
            while (rs.next()) {
                ...
                String query = rs.getString("comments");

                model.addRow(new Object[]{firstName, lastName, email, query});
            }
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "An error occurred while retrieving contact data", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel13.setText("V I E W   U S E R   Q U E R I E S");
        jLabel13.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 3, 0, new java.awt.Color(51, 51, 51)));
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 20, 670, 80));
        ...
        tbl_display.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "First Name", "Last Name", "Email", "QUERY"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 170, 770, 450));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewUserQueries.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminViewUserQueries(username).setVisible(true);
            }
        });
    }
