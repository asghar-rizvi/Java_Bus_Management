 ...
 */
public class AdminViewReser extends javax.swing.JFrame {

    /**
     * Creates new form AdminViewReser
     */
    static String username;
    public AdminViewReser(String username) {
        initComponents();
...
String sql = "{call DisplayReservationAdmin()}"; // Call the stored procedure
...
try (Connection conn = DriverManager.getConnection(connectionString, "admin", "123456");
    ...
    while (rs.next()) {
        ...
        String paymentMethod = rs.getString("Payment_method"); // Use PaymentMethod alias
        double amount = rs.getDouble("Amount");

        model.addRow(new Object[]{name, email, status, paymentMethod, amount});
    }
    ...
    e.printStackTrace();
    JOptionPane.showMessageDialog(null, "An error occurred while retrieving reservation data", "Error", JOptionPane.ERROR_MESSAGE);
}
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 140, 200, 40));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("V I E W   A L L   R E S E R V A T I O N S");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 270, 770, 450));
        ...
        getContentPane().add(txt_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 140, 410, 40));
    ...
    tbl_display.clearSelection();        // TODO add your handling code here:
    ...
    private void txt_nameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_nameKeyReleased
        ...
        obj1.setRowFilter(RowFilter.regexFilter(txt_name.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewReser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminViewReser(username).setVisible(true);
            }
        });
    }
