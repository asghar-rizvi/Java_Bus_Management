...
public class AdminViewFeedback extends javax.swing.JFrame {
    ...
    public AdminViewFeedback(String username) {
        initComponents();
...
String sql = "{call ViewFeedback()}"; // Call the stored procedure
...
try (Connection conn = DriverManager.getConnection(connectionString, "admin", "123456");
    ...
    while (rs.next()) {
        ...
        model.addRow(new Object[]{name, busId, fare, routeId, rating, comments});
    }
    ...
    e.printStackTrace();
    JOptionPane.showMessageDialog(null, "An error occurred while retrieving feedback data", "Error", JOptionPane.ERROR_MESSAGE);
}
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 160, 770, 450));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminViewFeedback(username).setVisible(true);
            }
        });
    }
